...
Datasets are typically created using the [`Dataverse`](../dataverse/) class's `create_dataset()` method or a [`Collection`](../collection/)'s `create_dataset()` method:
...
- **[`Dataverse`](../dataverse/)** - Factory class for creating and managing datasets
- **[`Collection`](../collection/)** - Represents a Dataverse collection that can contain datasets
...
- [File Documentation](../file/) - Learn more about working with individual files

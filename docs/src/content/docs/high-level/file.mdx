...
- **`dataset`** (Dataset): A reference to the parent [`Dataset`](/high-level/dataset/) instance that contains this file. This provides access to dataset-level operations and ensures the file knows its context within the dataset structure.
...
- **[`Dataset`](/high-level/dataset/)** - Represents a Dataverse dataset that contains files
- **[`Dataverse`](/high-level/Dataverse/)** - Factory class for creating and managing datasets and collections
- **[`Collection`](/high-level/collection/)** - Represents a Dataverse collection that can contain datasets with files

## See Also

- [Dataset Documentation](/high-level/dataset/) - Learn more about working with datasets and their files

...
- **[`Dataverse`](/high-level/Dataverse/)** - Factory class that provides the `search()` method
- **[`Collection`](/high-level/collection/)** - Represents a Dataverse collection with direct access to its content
- **[`Dataset`](/high-level/dataset/)** - Represents a Dataverse dataset that can be accessed from search results
- **[Search API](/apis/search/)** - Low-level search API for advanced search options

## See Also

- [Dataverse Documentation](/high-level/Dataverse/) - Learn more about the Dataverse factory class
- [Collection Documentation](/high-level/collection/) - Learn more about working with collections directly
- [Dataset Documentation](/high-level/dataset/) - Learn more about working with datasets
